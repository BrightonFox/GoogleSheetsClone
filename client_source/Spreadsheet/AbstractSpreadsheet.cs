...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// Visit iterates through the direct dependents to find circular dependencies and throw an exception.
        /// It does this by reccursively going through the direct dependents of name to see if any match the starting 
        /// name, indicating a circular dependency. It knows which dependents it has visited and will not go over them
        /// again by checking the visited set. If no exceptions are thrown, the changed list will contain
        /// a set of cells that have dependency relations in Depth First Search order. This is used in GetCellsToRecalculate
        /// to know what cells need to be updated when one in the chain has changed.
        /// </summary>
